#!/bin/bash -l
#
#SBATCH --job-name=kaiju-bin15.sh.coassembly
#SBATCH -t 4:00:00
#SBATCH --mem=57344
#SBATCH -o /home/jemizzi/rotation-project/scripts/error-output-reports/kaiju-bin15.sh.coassembly.out
#SBATCH -e /home/jemizzi/rotation-project/scripts/error-output-reports/kaiju-bin15.sh.coassembly.err
