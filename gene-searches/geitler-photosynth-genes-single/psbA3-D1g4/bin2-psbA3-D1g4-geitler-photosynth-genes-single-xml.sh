#!/bin/bash -l
#
#SBATCH --job-name=bin2-psbA3-D1g4-geitler-photosynth-genes-xml.sh
#SBATCH -t 10:00:00
#SBATCH --mem=32768
#SBATCH -o /home/jemizzi/rotation-project/scripts/error-output-reports/bin2-psbA3-D1g4-geitler-photosynth-genes-xml.sh.out
#SBATCH -e /home/jemizzi/rotation-project/scripts/error-output-reports/bin2-psbA3-D1g4-geitler-photosynth-genes-xml.sh.err
...
blastx -query /home/jemizzi/rotation-project/visualization-anvio/combined/SUMMARY_CONCOCT/bin_by_bin/Bin_2/Bin_2-contigs.fa -db /home/jemizzi/rotation-project/gene-search-custom-db/geitler-photosynth-genes-single/psbA3-D1g4/psbA3-D1g4-geitler-photosynth-genes-single.db -out /home/jemizzi/rotation-project/gene-search-custom-db/geitler-photosynth-genes-single/psbA3-D1g4/bin2-psbA3-D1g4-geitler-photosynth-genes-single.xml -outfmt 5
