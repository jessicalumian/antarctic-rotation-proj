#!/bin/bash -l
#
#SBATCH --job-name=metagenome-geitler-photosynth-genes.sh
#SBATCH -t 10:00:00
#SBATCH --mem=32768
#SBATCH -o /home/jemizzi/rotation-project/scripts/error-output-reports/metagenome-geitler-photosynth-genes.sh.out
#SBATCH -e /home/jemizzi/rotation-project/scripts/error-output-reports/metagenome-geitler-photosynth-genes.sh.err
...
blastx -query /home/jemizzi/rotation-project/assembly/metagenome/megahit-assembly/final.contigs.fa -db /home/jemizzi/rotation-project/gene-search-custom-db/geitler-photosynth-genes/geitler-photosynth-genes.db -out /home/jemizzi/rotation-project/gene-search-custom-db/geitler-photosynth-genes/metagenome-geitler-photosynth-genes.out -outfmt 6
