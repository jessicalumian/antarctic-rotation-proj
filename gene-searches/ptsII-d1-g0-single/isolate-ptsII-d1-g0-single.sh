#!/bin/bash -l
#
#SBATCH --job-name=isolate-ptsII-d1-g0-single.sh
#SBATCH -t 10:00:00
#SBATCH --mem=32768
#SBATCH -o /home/jemizzi/rotation-project/scripts/error-output-reports/isolate-ptsII-d1-g0-single.sh.out
#SBATCH -e /home/jemizzi/rotation-project/scripts/error-output-reports/isolate-ptsII-d1-g0-single.sh.err
...
blastx -query /home/jemizzi/rotation-project/assembly/isolate/megahit-assembly/final.contigs.fa -db /home/jemizzi/rotation-project/gene-search-custom-db/ptsII-d1-g0-single/ptsII-d1-g0-single.db -out /home/jemizzi/rotation-project/gene-search-custom-db/ptsII-d1-g0-single/metagenome-ptsII-d1-g0-single-hits.out -outfmt 6
