#!/bin/bash -l
#
#SBATCH --job-name=bin2-ptsII-d1-g4-single.sh
#SBATCH -t 10:00:00
#SBATCH --mem=32768
#SBATCH -o /home/jemizzi/rotation-project/scripts/error-output-reports/bin2-ptsII-d1-g4-single.sh.out
#SBATCH -e /home/jemizzi/rotation-project/scripts/error-output-reports/bin2-ptsII-d1-g4-single.sh.err
...
blastx -query /home/jemizzi/rotation-project/visualization-anvio/combined/SUMMARY_CONCOCT/bin_by_bin/Bin_2/Bin_2-contigs.fa -db /home/jemizzi/rotation-project/gene-search-custom-db/ptsII-d1-g4-single/ptsII-d1-g4-single.db -out /home/jemizzi/rotation-project/gene-search-custom-db/ptsII-d1-g4-single/bin2-ptsII-d1-g4-single-hits.out -outfmt 6
