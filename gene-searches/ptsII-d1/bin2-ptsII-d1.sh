#!/bin/bash -l
#
#SBATCH --job-name=bin2-ptsII-d1.sh
#SBATCH -t 10:00:00
#SBATCH --mem=32768
#SBATCH -o /home/jemizzi/rotation-project/scripts/error-output-reports/bin2-ptsII-d1.sh.out
#SBATCH -e /home/jemizzi/rotation-project/scripts/error-output-reports/bin2-ptsII-d1.sh.err
...
# query bin 2 against ptsII-d1 database
blastx -query /home/jemizzi/rotation-project/visualization-anvio/combined/SUMMARY_CONCOCT/bin_by_bin/Bin_2/Bin_2-contigs.fa -db /home/jemizzi/rotation-project/gene-search-custom-db/ptsII-d1/all-ptsII-d1.db -out /home/jemizzi/rotation-project/gene-search-custom-db/ptsII-d1/bin2-ptsII-d1-hits.out -outfmt 6
