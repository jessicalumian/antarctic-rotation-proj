#!/bin/bash -l
#
#SBATCH --job-name=bin2-kegg-sulfur-metabolism.sh
#SBATCH -t 10:00:00
#SBATCH --mem=32768
#SBATCH -o /home/jemizzi/rotation-project/scripts/error-output-reports/bin2-kegg-sulfur-metabolism.sh.out
#SBATCH -e /home/jemizzi/rotation-project/scripts/error-output-reports/bin2-kegg-sulfur-metabolism.sh.err
...
# query bin 2 against sqr database
blastx -query /home/jemizzi/rotation-project/visualization-anvio/combined/SUMMARY_CONCOCT/bin_by_bin/Bin_2/Bin_2-contigs.fa -db /home/jemizzi/rotation-project/gene-search-custom-db/kegg-sulfur-metabolism/all-kegg-sulfur-metabolism.db -out /home/jemizzi/rotation-project/gene-search-custom-db/kegg-sulfur-metabolism/bin2-kegg-sulfur-metabolism-hits.out -outfmt 6
