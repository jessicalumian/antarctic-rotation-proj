#!/bin/bash -l
#
#SBATCH --job-name=bwa2-mapping.sh.metagenome-fixed-contigs
#SBATCH -t 10:00:00
#SBATCH --mem=32768
#SBATCH -o /home/jemizzi/rotation-project/scripts/error-output-reports/bwa2-mapping.sh.metagenome-fixed-contigs.out
#SBATCH -e /home/jemizzi/rotation-project/scripts/error-output-reports/bwa2-mapping.sh.metagenome-fixed-contigs.err
...
# convert sam to bam
samtools import /home/jemizzi/rotation-project/mapping/metagenome/bwa2-samtools-output-fixed-contigs-anvio/contigs.fa.fai /home/jemizzi/rotation-project/mapping/metagenome/bwa2-samtools-output-fixed-contigs-anvio/metagenome-mapped-fixed-contigs.sam /home/jemizzi/rotation-project/mapping/metagenome/bwa2-samtools-output-fixed-contigs-anvio/metagenome-mapped-fixed-contigs.bam
