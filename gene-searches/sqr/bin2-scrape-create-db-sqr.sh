#!/bin/bash -l
#
#SBATCH --job-name=bin2-scrape-create-db-sqr.sh
#SBATCH -t 10:00:00
#SBATCH --mem=32768
#SBATCH -o /home/jemizzi/rotation-project/scripts/error-output-reports/bin2-scrape-create-db-sqr.sh.out
#SBATCH -e /home/jemizzi/rotation-project/scripts/error-output-reports/bin2-scrape-create-db-sqr.sh.err
...
blastx -query /home/jemizzi/rotation-project/visualization-anvio/combined/SUMMARY_CONCOCT/bin_by_bin/Bin_2/Bin_2-contigs.fa -db /home/jemizzi/rotation-project/gene-search-custom-db/sqr/all-sqr.db -out /home/jemizzi/rotation-project/gene-search-custom-db/sqr/bin2-sqr-metagenome-hits.out -outfmt 6
